...
export declare class HTMLCanvasElementLuminanceSource {
    constructor(canvas: HTMLCanvasElement);
}

export declare class HybridBinarizer {
    constructor(luminanceSource: HTMLCanvasElementLuminanceSource);
}

export declare class BinaryBitmap {
    constructor(binarizer: HybridBinarizer);
}

export declare class MultiFormatReader {
    constructor(verbosity: boolean, b: any);
    decode(binaryBitmap: BinaryBitmap): any;
    decodeWithState(binaryBitmap: BinaryBitmap): any;
}
